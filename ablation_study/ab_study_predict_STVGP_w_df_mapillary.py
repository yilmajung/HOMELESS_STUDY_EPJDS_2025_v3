...
scaler = joblib.load('scaler_ab_study_w_mapillary.joblib')
constant_mean = joblib.load('constant_mean_ab_study_w_mapillary.pkl')
inducing_points = torch.load('inducing_points_ab_study_w_mapillary.pt', map_location=device)
...
model.load_state_dict(torch.load('stvgp_ab_study_w_mapillary.pth', map_location=device))
likelihood.load_state_dict(torch.load('likelihood_ab_study_w_mapillary.pth', map_location=device))
...
df_test.to_csv('stvgp_ab_study_w_mapillary_noclamp.csv', index=False)
