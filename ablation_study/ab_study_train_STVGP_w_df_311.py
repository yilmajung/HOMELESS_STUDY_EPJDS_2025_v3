...
joblib.dump(scaler, "scaler_ab_study_w_311.joblib")

log_y_mean = np.log(y.mean() + 1e-3).astype(np.float32)
joblib.dump(log_y_mean, "constant_mean_ab_study_w_311.pkl")
...
# Save
torch.save(model.state_dict(), 'stvgp_ab_study_w_311.pth')
torch.save(likelihood.state_dict(), 'likelihood_ab_study_w_311.pth')
torch.save(inducing_points, 'inducing_points_ab_study_w_311.pt')
